...
popup. Browser popup permissions remain browser-controlled; if the opener
reports an error, the workspace shows a retry action. Allow popups for the
chart origin before retrying.
